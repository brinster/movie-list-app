...
export default function SearchMoviesPage() {
    ...
    const studioOptions = ["A24", "Arrow", "Criterion", "Kino Lorber", "Lionsgate", "Paramount", "Shout!", "Sony", "Universal", "Warner Bros"];
    ...
    return (
        <Box position="relative" zIndex={1}>
            ...
            <Box bg="gray.800" borderRadius="12px" p={4} mb={3} boxShadow="0 4px 24px rgba(0,0,0,0.35)">
                <HStack spacing={3}>
                    <Input placeholder="Search for a movie..." value={query} onChange={(e) => setQuery(e.target.value)} onKeyDown={(e) => e.key === "Enter" && searchMovies()} bg="gray.700" color="white" />
                    <Button onClick={searchMovies} bg="teal.500" color="white">Search</Button>
                </HStack>
            </Box>
            ...
            <Modal isOpen={isOpen} onClose={onClose} isCentered>
                ...
                <ModalContent bg="gray.800" color="white" borderRadius="12px">
                    ...
                    <ModalFooter><Button bg="teal.500" w="full" onClick={addMovie}>Add to Library</Button></ModalFooter>
                </ModalContent>
            </Modal>
        </Box>
    );
